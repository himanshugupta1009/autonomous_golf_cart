...
initial_human_goal_distribution_list = [0.15,0.3,0.5,0.05,0.1,0.3,0.1,0.5,0.5,0.25,0.1,0.15,0.05,0.5,0.35,0.1]

given_astar_path = [8, 30,7, 30,7, 29,7, 28,7, 27,7, 26,7, 25, 7, 24,7, 23,7, 22,6, 22,6, 21,5, 21,5, 20,5, 19, 5, 18,5, 17,5, 16,5, 15,5, 14,5, 13,5, 12,5, 11,5, 10,5, 9,5, 8,5, 7,5, 6,5, 5,5, 4,5, 3,5, 2,5, 1,6, 1,7, 1]
